...
setwd(expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+e_M0_mr3/"))

# Input geography
lgdata_fn = expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+e_M0_mr3/geog.data")
geog_df = Parsers.getranges_from_LagrangePHYLIP(lgdata_fn)

# Input tree
trfn = expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+e_M0_mr3/tree.newick")
...
library(diversitree)
library(BioGeoBEARS)
wd = "~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+e_M0_mr3/"  # CHANGE THIS
setwd(wd)
