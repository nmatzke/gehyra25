...
"""
# Run with:
cd(expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+d=e=D_M0_mr3/"))
include(expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+d=e=D_M0_mr3/phybears_M0_mr3_DEC+J_B+d=e=D_v2.jl"))
"""


setwd(expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+d=e=D_M0_mr3/"))

# Input geography
lgdata_fn = expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+d=e=D_M0_mr3/geog.data")
geog_df = Parsers.getranges_from_LagrangePHYLIP(lgdata_fn)

# Input tree
trfn = expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+d=e=D_M0_mr3/tree.newick")
...
bmo.init[bmo.rownames .== "j"] .= j_start
bmo.est[bmo.rownames .== "j"] .= j_start
numareas = 6
...
inputs = setup_DEC_SSE2(numareas, tr, geog_df; root_age_mult=2.5, max_range_size=max_range_size, include_null_range=false, bmo=bmo);
...
#pars = [0.01, 0.01, 0.01]
pars = [d_start, j_start, birthRate]
...
library(diversitree)
library(BioGeoBEARS)
wd = "~/GitHub/gehyra25/03_M0+BD/phybears_DECj+B+d=e=D_M0_mr3/"  # CHANGE THIS
setwd(wd)
...
pdffn = "phyBEARS_Gehyra2_DEC+J+B+d=e=D_M0_unconstrained_v1.pdf"  # CHANGE THIS
pdf(pdffn, height=12, width=9)
analysis_titletxt ="PhyBEARS DEC+J+B+d=e=D on Gehyra M0_unconstrained"  # CHANGE THIS
results_object = res
