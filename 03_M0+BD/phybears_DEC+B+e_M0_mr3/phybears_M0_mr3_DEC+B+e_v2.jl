...
setwd(expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DEC+B+e_M0_mr3/"))

# Input geography
lgdata_fn = expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DEC+B+e_M0_mr3/geog.data")
geog_df = Parsers.getranges_from_LagrangePHYLIP(lgdata_fn)

# Input tree
trfn = expanduser("~/GitHub/gehyra25/03_M0+BD/phybears_DEC+B+e_M0_mr3/tree.newick")
...
bmo.est[bmo.rownames .== "deathRate"] .= 0.0007
bmo.est[bmo.rownames .== "d"] .= 0.0010
bmo.init[bmo.rownames .== "e"] .= 0.0007
...
bmo.init[bmo.rownames .== "birthRate"] .= birthRate
bmo.est[bmo.rownames .== "birthRate"] .= birthRate
bmo.init[bmo.rownames .== "deathRate"] .= 0.0007
bmo.est[bmo.rownames .== "deathRate"] .= 0.0007
bmo.est[bmo.rownames .== "d"] .= 0.0010
bmo.est[bmo.rownames .== "e"] .= 0.0007
bmo.est[bmo.rownames .== "a"] .= 0.0
...
library(diversitree)
library(BioGeoBEARS)
wd = "~/GitHub/gehyra25/03_M0+BD/phybears_DEC+B+e_M0_mr3/"  # CHANGE THIS
setwd(wd)
